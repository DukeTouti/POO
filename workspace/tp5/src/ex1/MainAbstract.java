...
public class MainAbstract {
	...
	public static void main(String[] args) throws IOException {
		...
		ps.println("|           Version Classe Abstraite             |");
		ps.println("==================================================\n");
	...
	private static void ajouterEmploye() throws IOException {
		...
		if (type == 1) {
			employes.add(new EmpServiceTech(nom, prenom, salaire));
			ps.println("\n  Employé Service Technique ajouté !");
		} else {
			employes.add(new EmpServiceAdmin(nom, prenom, salaire));
	...
	private static void calculerCotisations() {
		...
		ps.printf("\n--> Nombre d'employés : %d\n", employes.size());
		ps.printf("--> Total des salaires : %.2f €\n", totalSalaires);
